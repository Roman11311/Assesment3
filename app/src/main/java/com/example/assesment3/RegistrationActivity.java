...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private void saveUserCredentials(String username, String email, String password) {
        ...
        // Debug logs to check saved data
        Log.d("RegistrationActivity", "Saved Username: " + username);
        Log.d("RegistrationActivity", "Saved Email: " + email);
        Log.d("RegistrationActivity", "Saved Password: " + password);
    }
}
